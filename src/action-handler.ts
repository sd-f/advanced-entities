...
declare global {
  interface HTMLElementTagNameMap {
    'advanced-entities-action-handler': ActionHandlerType;
  }
...
class ActionHandlerImpl extends HTMLElement implements ActionHandlerType {
  public holdTime = 500;
  ...
  private repeatTimeout: ReturnType<typeof setInterval> | undefined;
...
const getActionHandler = (): ActionHandlerType => {
  ...
  if (body.querySelector('advanced-entities-action-handler')) {
    return body.querySelector('advanced-entities-action-handler') as ActionHandlerType;
  }
